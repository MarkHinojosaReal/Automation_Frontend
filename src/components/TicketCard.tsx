        ...
        <div className="py-4 px-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className={`px-3 py-1 text-xs font-medium rounded-full backdrop-blur-sm ${getPriorityColor(ticket.priority.color)}`}>
    ...
    <div className="card group hover:shadow-2xl">
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center space-x-4">
          <span className={`px-3 py-1 text-xs font-medium rounded-full backdrop-blur-sm ${getTypeColor(ticket.type.color)}`}>
            {ticket.type.name}
          </span>
          <span className={`px-3 py-1 text-xs font-medium rounded-full backdrop-blur-sm ${getPriorityColor(ticket.priority.color)}`}>
            {ticket.priority.name}
